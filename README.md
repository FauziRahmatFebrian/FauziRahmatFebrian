...
![Core Tech](https://skillicons.dev/icons?i=py,java,scala,postgres,mysql,mongodb,elasticsearch,gcp,docker,kubernetes,linux)


### Other Tech Stacks

![Other Tech](https://skillicons.dev/icons?i=js,c,html,tailwind,webpack,vite,nginx,graphql,sqlite,scipy,kafka,aws)

### Tools

![Tools](https://skillicons.dev/icons?i=git,github,gitlab,selenium,vscode,anaconda,postman,figma,notion,trello)
